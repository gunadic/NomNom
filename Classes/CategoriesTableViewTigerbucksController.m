//
//  CategoriesTableViewTigerbucksController.m
//  NomNom
//
...
@implementation CategoriesTableViewTigerbucksController
@synthesize tigerBucksArray;
@synthesize restaurantDetailViewController;
@synthesize xmlTigerBucks;

//================================================================================================
//  Purpose: This class serves to be the controller for the categories view of the off campus 
//           portion. It displays the list of restaurants in the DB that accept Tigerbucks. It  
...
- (void)viewDidLoad {
	...
	NSString* queryTigerBucks = @"SELECT * FROM `RestDB`WHERE `TigerBucks` =1 ORDER BY Name ASC";
	NSString* argsTigerBucks = @"";

	URLCreater *urlCreaterTigerBucks = [[URLCreater alloc] init];
	
	NSURL *urlTBucks = [urlCreaterTigerBucks buildOurURL:queryTigerBucks :argsTigerBucks];
	
	NSURLRequest *req = [NSURLRequest requestWithURL:urlTBucks
										 cachePolicy:NSURLRequestReloadIgnoringCacheData
									 timeoutInterval:30.0];
	[NSURLConnection connectionWithRequest:req delegate:self];
	
	self.tigerBucksArray = xmlData;
	
	self.title = NSLocalizedString(@"TigerBucks", @"Trinity's Favorite Restaurants");
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    return [self.tigerBucksArray count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	contentForThisRow = [[self tigerBucksArray] objectAtIndex:row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    */
	...
	tmp = [[self tigerBucksArray] objectAtIndex:row];
...
-(void) connectionDidFinishLoading:(NSURLConnection *)conn {
	...
	xmlTigerBucks = [[XMLParser alloc] init];
	
	[tigerBucksArray removeAllObjects];
	tigerBucksArray = [xmlTigerBucks parseDocument:wipData];
